  ...
  return (
    <>
      ...
      <form onSubmit={handleLogin} className="admin-card space-y-6">
        ...
        <button type="submit" disabled={loading} className="admin-btn-primary w-full disabled:opacity-50 disabled:cursor-not-allowed">
...
function LoginFormFallback() {
  return (
    <div className="admin-card space-y-6 animate-pulse">
      <div className="h-12 bg-[var(--barber-border)] rounded" />
      <div className="h-12 bg-[var(--barber-border)] rounded" />
      <div className="h-12 bg-[var(--barber-border)] rounded" />
    </div>
  )
